...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default=["./H&N_dataset/"], type=list, help="dataset directory")
    parser.add_argument("--report_dir", default="./H&N_dataset/filtered.csv", type=str, help="report file path")
    ...
    parser.add_argument("--c_max", default=2, type=int, help="max class")
    ...
    args.data_dir = ["./H&N_dataset/"]
    args.report_dir = ["./H&N_dataset/filtered.csv"]
